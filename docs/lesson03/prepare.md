...
Shows the call stack from a Python program running in Visual Studio Code when a breakpoint was reached an paused the software.

Python Exception showing Function Stack
